        ...
        <div class="row">
            ...
            @foreach($seancesVenir as $reservation)
                <div class="col-md-4 img-portfolio">
                    ...
                    <button type='button' value= "{{ $reservation->id_reservation}}" data-reservation="{{ $reservation->id_reservation}}" class="btn btn-primary bouton-annuler-reservation"> Annuler réservation</button>
                </div>
